...
parser:
	...
	$(CC) $(CCFLAGS) $(SRC_FOLDER)/symbolTable.c $(SRC_FOLDER)/jsonToAst.c $(SRC_FOLDER)/genericToAst.c $(SRC_FOLDER)/basicTypeToAst.c $(SRC_FOLDER)/expToAst.c $(SRC_FOLDER)/astToHTML.c lex.yy.c y.tab.c $(SRC_FOLDER)/main.c $(YLFLAGS) -o jtoh
	rm -rf $(OBJ)
